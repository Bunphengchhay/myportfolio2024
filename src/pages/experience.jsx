...
export default function Experiences({isDarkMode, mainStyle}) {
  return (
    ...
    <div className="w-full p-4 z-20" style={mainStyle}>
...
function Card({ item, i }) {
  ...
  return (
    <>
        <motion.div
            ref={containerRef}
            className={`card-container-${i} mt-2`}
            style={{
                opacity,
                scale,
            ...
            <div className="w-full flex justify-center items-center">
                <div
                className="card w-full px-4 py-2 flex flex-col text-left overflow-y-auto bg-stone-800 text-white cursor-pointer rounded-xl hover:bg-stone-900 transition-all duration-300"
                ...
                <div className="w-full flex flex-cols justify-start items-center gap-4 md:gap-16 items-center">
                    ...
                    />
                    <div>
                    <h2 className="text-base md:text-xl font-bold mt-2">{item.Position}</h2>
                    <h3 className="text-sm text-yellow-400">{item.Employer}</h3>
                    <p className="text-sm mb-1">{item.Date}</p>
                    {/* <p className="text-sm">....</p> */}
                    <img src={viewmore} alt='arrow down' width={15} height={15} />
                    </div>
                </div>
                </div>
            </div>
