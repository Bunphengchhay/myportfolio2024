      ...
      <div>
            ...
            <Element name= 'home' className="introduction" >
              {scrollPosition < 500 && <div className= {introFixedTop} style={{color: 'black'}} id="intro-main">
                <div className="mainfixedTop">
                  <div>
                    <div>
                      <img src={me02} style={{width: '20rem', height: '15rem'}} alt="my photo"/>
                    </div>
                    <h1 style={{fontSize: '1.2rem', marginBottom: '0px'}}> Hi there!</h1>
                    <div className="myintro"> 
                      <p style={{fontSize: '0.8rem'}}> I am Bunpheng CHHAY (PENCE), a Computer Science Student. I am passionate about <strong> DevSecOps, Cloud Platforms, Data Science,</strong> and utilizing <strong> Deep Learning </strong> models for business insights. </p>
                    </div>
                
                    <div className="flex-container">
                      <p className="flex-item">Find me on</p>
                      <div style={{ width: '10px', height: '1px', backgroundColor: 'black', marginLeft: '2px'}}></div>
                      <SocialContact/>
                    </div>
                  </div>
                </div>
                <div className="mainfixedBottom">
                  <div>
                    ...
                    <p style={{fontSize: '0.8rem'}}> I am Computer Science Student. I am passionate about <strong> DevSecOps, Cloud Platforms, Data Science,</strong> and utilizing <strong> Deep Learning </strong> models for business insights. </p>
                  </div>
                </div>
              </div>}
            </Element>

              <div className="body-content" style={{maxWidth: '1500px', margin: '0 auto'}}>
                    <Skills/>
              </div>
        ...
        <div className="main-content2">
          <Element name = 'schoolproject'>
            ...
            <h1 style={{marginBottom: 0, marginTop: 50, textAlign: 'center', fontSize: '2rem', color: 'black', backgroundColor: '#D5DAD6', borderTopRightRadius: '30px', borderTopLeftRadius: '30px'}}> Data Sciences </h1>
