    ...
    return ( 
        <div className="aws" style={{maxWidth: '1200px', margin: '0 auto',  marginBottom: '100px'}}>
         ...
         <div style={{width: '100%', height: 1, backgroundColor: 'grey', marginTop: 0, marginBottom: 30}}> </div>
            ...
            <Element style={{textAlign: 'center'}}>
                    ...
                    
                {
                    awsExperiences.map((experience, index) => (
                        <div key={index} style={{minWidth: '300px', minHeight: '280px', margin: '5px'}} id = "expbox">
                            <p style={{fontSize: '18px', color: 'white', marginTop: '5%', backgroundColor: '#40826D'}}>{experience.title}</p>
                            <div style={{width: '90%', height: '1px', backgroundColor: '#40826D', margin: '5%'}}/>
                            <p style={{fontSize: '1rem'}}>{experience.task}</p>
                        </div>
                    ))
                }
            ...
            <Element >
                    <div style={{width: 'inherit', marginTop: '50px'}}>
         ...
         <div style={{width: '100%', height: 1, backgroundColor: 'grey', marginTop: 0, marginBottom: 30}}> </div>
         <Element style={{textAlign: 'center'}}>
                <h1 style={{fontSize: '18px'}}> Associate Manager </h1>
                <h3 style={{color: '#40826D', margin: 0, fontSize: '2rem'}}> TLBU Foundations </h3>
                <h1 style={{fontSize: '18px', margin: 0}}> Atlantic City, NJ</h1>
                <h1 style={{fontSize: '18px', margin: 0, marginBottom: 20}}> 2017 - 2019</h1>
                    ...
                    
                {
                    tlbuExperiences.map((experience, index) => (
                        <div key={index} style={{minWidth: '250px', minHeight: '250px', margin: '5px'}} id = "expbox">
                            <p style={{fontSize: '18px', color: 'white', marginTop: '5%', backgroundColor: '#40826D'}}>{experience.title}</p>
                            <div style={{width: '90%', height: '1px', backgroundColor: '#40826D', margin: '5%'}}/>
                            <p style={{fontSize: '1rem'}}>{experience.task}</p>
                        </div>
